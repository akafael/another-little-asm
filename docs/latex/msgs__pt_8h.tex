...
\item 
\#define \hyperlink{msgs__pt_8h_acb4b755b37f4e2bec7953cb4bdab82d0}{P\-R\-I\-N\-T\-\_\-\-E\-R\-R\-\_\-\-I\-N\-S\-T\-R\-U\-C\-T\-I\-O\-N}(file\-Line, I\-N\-S\-T)~cout $<$$<$ \char`\"{}Linha \char`\"{} $<$$<$ file\-Line +1 $<$$<$ \char`\"{} \-: \textbackslash{}e\mbox{[}31\char`\"{}$<$$<$ string(I\-N\-S\-T) $<$$<$\char`\"{} -\/$>$ Instrução Inválida\textbackslash{}e\mbox{[}0\textbackslash{}n\char`\"{}
...
{\bfseries Valor\-:}
\begin{DoxyCode}
cout << \textcolor{charliteral}{'\(\backslash\)n'} << string(fileName) << \textcolor{stringliteral}{": Linha "} << \(\backslash\)
                                          fileLine + 1 << \textcolor{stringliteral}{": ERROR:"} << \(\backslash\)
                                          MSG << \textcolor{stringliteral}{"\(\backslash\)n"}
\end{DoxyCode}
...
\item[{}]{I\-N\-S\-T}
\end{DoxyParamCaption}
)~cout $<$$<$ \char`\"{}Linha \char`\"{} $<$$<$ file\-Line +1 $<$$<$ \char`\"{} \-: \textbackslash{}e\mbox{[}31\char`\"{}$<$$<$ string(I\-N\-S\-T) $<$$<$\char`\"{} -\/$>$ Instrução Inválida\textbackslash{}e\mbox{[}0\textbackslash{}n\char`\"{}}}\label{msgs__pt_8h_acb4b755b37f4e2bec7953cb4bdab82d0}
